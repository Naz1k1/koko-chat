...
@RestControllerAdvice(basePackages = {"dev.koko.chat.auth", "dev.koko.chat.message", "dev.koko.chat.contact", "dev.koko.chat.group", "dev.koko.chat.attachment","dev.koko.chat.call","dev.koko.chat.ops"})
